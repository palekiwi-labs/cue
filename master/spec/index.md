...
## Overview
`mem` is a CLI tool and protocol for managing **Agent Memory** and cross-session continuity. It allows AI agents to maintain a persistent state of context, intent, and historical discoveries within a Git-tracked project.
...
- **Isolation**: Stored in `.mem/` (mounted via worktree to an orphan branch).
